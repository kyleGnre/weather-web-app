    ...
    <div className="bg-gray-800 h-screen w-screen grid grid-cols-[auto,1fr] p-8 gap-8">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          />
          <p className="text-white text-2xl">SWEN - Group 7</p>
        </div>
        ...
        <div className="grid grid-rows-3 gap-8">
            ...
            <div className="bg-gray-700 p-8 rounded-[20px]">
                ...
                <div className="grid grid-cols-4 gap-8">  
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-white text-3xl">{weatherData.uv ? `${weatherData.uv}` : '0.0'}</p>
                  </div>
                </div>
            </div>
        </div>
          ...
          <div className="bg-white p-6 rounded-[20px] min-h-[300px] relative"> {/* Add relative positioning here */}
            ...
            {/* 7 Day Forecast */}
            <div className="bg-gray-700 p-8 rounded-[20px] min-h-[300px]"> {/* ... */}
                  ...
                  weatherData.forecast.map((day: { date: string; rain_chance: number; temp: number }, index) => {
                    ...
                    return (
                      <div key={index} className="flex flex-col items-center justify-center h-full">
                        <p className="text-xl mb-2" style={{ fontWeight: 'bold' }}>{displayDate}</p> {/* Day names */}
                        <p className="text-2xl mb-6">{Math.round(day.temp)}°{getUnitSymbol(units)}</p> {/* Temperature */}
                        <div className="text-xl text-center">
                        <p className="text-xl mb-2" style={{ fontWeight: 'bold' }}>Rain:</p>
                          <p className="text-2xl mb-2">{Math.round(day.rain_chance)}%</p> {/* Rain chance */}
                        </div>
                      </div>
                    );
                  })
      ...
      <div className="grid grid-cols-1 grid-rows-1 gap-8">
        <div className="grid grid-rows-1 gap-8">
          <div className="bg-gray-700 p-8 rounded-[20px] min-h-[100px]">
            <p className="text-white text-4xl mb-4">Appearance - WIP</p>
